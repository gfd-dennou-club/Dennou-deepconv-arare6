      ...
      do j = jmin + 2, jmax - 2
        do i = imin + 2, imax - 2
          ...
          xyz_DPTempDtAdv(i,j,k) =                                               &
            ...
            &      xqz_VelYN(i,j,k)                                           &
            &        * (                                                      &
            &            fct1 * ( xyz_PTempN(i,j+1,k) - xyz_PTempN(i,j,k)   ) &
            &          - fct2 * ( xyz_PTempN(i,j+2,k) - xyz_PTempN(i,j-1,k) ) &
            &          )                                                      &
            &    + xqz_VelYN(i,j-1,k)                                         &
            &        * (                                                      &
            &            fct1 * ( xyz_PTempN(i,j,k)   - xyz_PTempN(i,j-1,k) ) &
            &          - fct2 * ( xyz_PTempN(i,j+1,k) - xyz_PTempN(i,j-2,k) ) &
            &          )                                                      &
            &   ) * 5.0d-1 / dy                                               &
            & - (                                                             &
            &      xyr_VelZN(i,j,k)                                           &
      ...
      do j = jmin + 2, jmax - 2
        do i = imin + 2, imax - 2
          ...
          xyz_DExnerDtAdv(i,j,k) =                                               &
            ...
            &      xqz_VelYN(i,j,k)                                           &
            &        * (                                                      &
            &            fct1 * ( xyz_ExnerN(i,j+1,k) - xyz_ExnerN(i,j,k)   ) &
            &          - fct2 * ( xyz_ExnerN(i,j+2,k) - xyz_ExnerN(i,j-1,k) ) &
            &          )                                                      &
            &    + xqz_VelYN(i,j-1,k)                                         &
            &        * (                                                      &
            &            fct1 * ( xyz_ExnerN(i,j,k)   - xyz_ExnerN(i,j-1,k) ) &
            &          - fct2 * ( xyz_ExnerN(i,j+1,k) - xyz_ExnerN(i,j-2,k) ) &
            &          )                                                      &
            &   ) * 5.0d-1 / dy                                               &
            & - (                                                             &
            &      xyr_VelZN(i,j,k)                                           &
      ...
      do j = jmin + 2, jmax - 2
        do i = imin + 2, imax - 2
          ...
          xyz_DKmDtAdv(i,j,k) =                                            &
            ...
            &      xqz_VelYN(i,j,k)                                     &
            &        * (                                                &
            &            fct1 * ( xyz_KmN(i,j+1,k) - xyz_KmN(i,j,k)   ) &
            &          - fct2 * ( xyz_KmN(i,j+2,k) - xyz_KmN(i,j-1,k) ) &
            &          )                                                &
            &    + xqz_VelYN(i,j-1,k)                                   &
            &        * (                                                &
            &            fct1 * ( xyz_KmN(i,j,k)   - xyz_KmN(i,j-1,k) ) &
            &          - fct2 * ( xyz_KmN(i,j+1,k) - xyz_KmN(i,j-2,k) ) &
            &          )                                                &
            &   ) * 5.0d-1 / dy                                         &
            & - (                                                       &
            &      xyr_VelZN(i,j,k)                                     &
        ...
        do j = jmin + 2, jmax - 2
          do i = imin + 2, imax - 2
            ...
            xyzf_QMixAdv(i,j,k,s) =                                                 &
              ...
              &      xqz_VelYN(i,j,k)                                               &
              &        * (                                                          &
              &            fct1 * ( xyzf_QMixN(i,j+1,k,s) - xyzf_QMixN(i,j,k,s)   ) &
              &          - fct2 * ( xyzf_QMixN(i,j+2,k,s) - xyzf_QMixN(i,j-1,k,s) ) &
              &          )                                                          &
              &    + xqz_VelYN(i,j-1,k)                                             &
              &        * (                                                          &
              &            fct1 * ( xyzf_QMixN(i,j,k,s)   - xyzf_QMixN(i,j-1,k,s) ) &
              &          - fct2 * ( xyzf_QMixN(i,j+1,k,s) - xyzf_QMixN(i,j-2,k,s) ) &
              &          )                                                          &
              &   ) * 5.0d-1 / dy                                                   &
              & - (                                                                 &
              &      xyr_VelZN(i,j,k)                                               &
        ...
        do j = jmin + 2, jmax - 2
          do i = imin + 2, imax - 2
            ...
            xyzf_QMixNDiff(i,j,k,s) =                        &
              ...
              &   ) * NuHh / ( dx ** 4.0d0 )                 &
              & - (                                          &
              &       xyzf_QMixB(i,j+2,k,s)                  &
              &     + xyzf_QMixB(i,j-2,k,s)                  &
              &     - xyzf_QMixB(i,j+1,k,s) * 4.0d0          &
              &     - xyzf_QMixB(i,j-1,k,s) * 4.0d0          &
              &     + xyzf_QMixB(i,j  ,k,s) * 6.0d0          &
              &   ) * NuHh / ( dy ** 4.0d0 )                 &
              & - (                                          &
