...
#   * $Id: jupiter-plumetest.rd,v 1.1 2011/06/21 15:42:02 sugiyama Exp $
...
計算には 10 分程度かかると思います. 
  ...
  $ ./bin/arare_jupiter -N=arare-jupiter.conf


計算終了後, gpview などで描画を行ないます. 
例えば gpview で描画する場合, 以下のようにコマンドを打ちます. 

  $ gpview --wsn 4 arare-jupiter_PotTemp.nc@PotTemp --anim t
